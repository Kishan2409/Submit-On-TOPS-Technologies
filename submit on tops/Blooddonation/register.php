                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group m-2">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="mobile" maxlength="10" placeholder="Enter Valid Mobile Number"
                                    class="form-control " required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group m-2">
                        <div class="row">
                            ...
                            <div class="col-md-9 mt-2 offset-md-3 ">
                                <input type="text" maxlength="6" name="pin" placeholder="Enter Your Area Pincode" class="form-control"
                                    required>
                            </div>
                            <div class="col-md-9 mt-2 offset-md-3">
